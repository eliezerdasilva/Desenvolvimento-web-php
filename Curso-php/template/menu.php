<nav class="modulos">
                ...
                <div class="modulo roxo-escuro">   
                    ...
                    <ul>
                        ...
                        <li><a href="exercicio.php?dir=includes&file=include_funcao">Includes Função</a></li>
                        <li><a href="exercicio.php?dir=includes&file=include_require">Includes vs Require</a></li>
                        <li><a href="exercicio.php?dir=includes&file=require_return">Require Retorno</a></li>
                        <li><a href="exercicio.php?dir=includes&file=include_once">Include Once</a></li>
                        <li><a href="exercicio.php?dir=includes&file=desafio">Desafio do modulo</a></li>
                ...
                <div class="modulo roxo">   
                    ...
                    <ul>
                        ...
                        <li><a href="exercicio.php?dir=db&file=alterar">Alterar Registro #02</a></li>
